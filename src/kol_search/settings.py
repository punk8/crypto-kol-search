...
class Settings(BaseSettings):
    ...
    def backend_ready(self, name: str) -> tuple[bool, str | None]:
        ...
        if name == "opencli":
            ...
            ready = result.returncode == 0 and self.opencli_profile in output and "connected" in output
            return ready, None if ready else f"OpenCLI profile {self.opencli_profile!r} 未连接"
        return False, "未知后端"
